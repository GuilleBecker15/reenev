                ...
                <div class="panel-body">
                    <form onsubmit="return validarCampos();" class="form-horizontal" role="form" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nacimiento') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nacimiento" type="fecha" class="form-control" name="nacimiento" value="<?php echo e(old('nacimiento')); ?>" required autofocus>
                    ...
                    <div class="form-group<?php echo e($errors->has('ci') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="ci" type="cedula" class="form-control" name="ci" value="<?php echo e(old('ci')); ?>" placeholder="0.000.000-0" required autofocus>
