                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('nacimiento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nacimiento" type="fecha" class="form-control" name="nacimiento" value="{{ old('nacimiento') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('ci') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="ci" type="cedula" class="form-control" name="ci" value="{{ old('ci') }}" placeholder="0.000.000-0" required autofocus>
