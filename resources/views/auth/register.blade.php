                ...
                <div class="panel-body">
                    <form onsubmit="return validarCampos();" class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('apellido1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="apellido1" type="text" class="form-control" name="apellido1" value="{{ old('apellido1') }}" placeholder="Perez" required>
                        ...
                        <div class="form-group{{ $errors->has('nacimiento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nacimiento" type="fecha" class="form-control" name="nacimiento" value="{{ old('nacimiento') }}" required>
