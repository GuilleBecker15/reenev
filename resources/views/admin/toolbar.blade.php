					...
					<ul class="dropdown-menu">
						<li>
							<a href="{{ route('Cursos.create') }}">
								<span class="glyphicon glyphicon-book"></span> Nuevo curso
							</a>
						</li>
						<li>
							<a href="{{ route('Docentes.create') }}">
								<span class="glyphicon glyphicon-user"></span> Nuevo docente
							</a>
						</li>
						<li>
							<a href="{{ route('Encuestas.create') }}">
								<span class="glyphicon glyphicon-stats"></span> Nueva encuesta
							</a>
						</li>
					</ul>
				</span>
